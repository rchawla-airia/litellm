...
export interface BuildComplexityRouterConfigParams {
  ...
  heuristicFirstBoundaryMargin?: number;
...
const classifierWireFields = (
  ...
  ...(effectiveType === "heuristic_first" &&
    heuristicFirstBoundaryMargin !== undefined && { heuristic_first_boundary_margin: heuristicFirstBoundaryMargin }),
  ...(usesLlmClassifier(effectiveType) &&
