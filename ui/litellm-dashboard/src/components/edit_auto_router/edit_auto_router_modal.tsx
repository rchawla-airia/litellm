...
export interface StoredComplexityRouterConfig {
  ...
  heuristic_first_boundary_margin?: unknown;
  tier_labels?: unknown;
...
export const hydrateComplexityRouterConfig = (
  ...
  return {
    ...
    heuristic_first_boundary_margin:
      typeof parsedConfig.heuristic_first_boundary_margin === "number"
        ? parsedConfig.heuristic_first_boundary_margin
        : undefined,
    classification_mode:
...
export const buildUpdatedComplexityRouterConfig = (
  ...
  const builderParams: BuildComplexityRouterConfigParams = {
    ...
    heuristicFirstBoundaryMargin: value.heuristic_first_boundary_margin,
