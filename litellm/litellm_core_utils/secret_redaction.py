...
def redact_internal_details(value: str) -> str:
    """Scrub filesystem paths and internal hostnames from *value*, on top of the
    credential patterns redact_string() already covers.
    ...
    """
    return _INTERNAL_DETAIL_RE.sub(_REDACTED, redact_string(value))
